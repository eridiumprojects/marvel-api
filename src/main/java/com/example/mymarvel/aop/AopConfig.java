...
//*
//1 метод редактирования имени объекта по айди (для обеих сущностей) - не забыть проверку на уникальность имени - done
//2 логирование сохранения новых объектов через аоп - done
//3 логика проверки уникальности при сохранении - done
